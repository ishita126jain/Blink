...
from mediapipe.tasks.cc.components.proto import segmenter_options_pb2 as mediapipe_dot_tasks_dot_cc_dot_components_dot_proto_dot_segmenter__options__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  serialized_pb=_b('\nSmediapipe/tasks/cc/vision/image_segmenter/proto/image_segmenter_graph_options.proto\x12,mediapipe.tasks.vision.image_segmenter.proto\x1a$mediapipe/framework/calculator.proto\x1a;mediapipe/tasks/cc/components/proto/segmenter_options.proto\x1a\x30mediapipe/tasks/cc/core/proto/base_options.proto\"\xc5\x02\n\x1aImageSegmenterGraphOptions\x12=\n\x0c\x62\x61se_options\x18\x01 \x01(\x0b\x32\'.mediapipe.tasks.core.proto.BaseOptions\x12 \n\x14\x64isplay_names_locale\x18\x02 \x01(\t:\x02\x65n\x12M\n\x11segmenter_options\x18\x03 \x01(\x0b\x32\x32.mediapipe.tasks.components.proto.SegmenterOptions2w\n\x03\x65xt\x12\x1c.mediapipe.CalculatorOptions\x18\x9e\xc7\xb8\xda\x01 \x01(\x0b\x32H.mediapipe.tasks.vision.image_segmenter.proto.ImageSegmenterGraphOptionsBY\n6com.google.mediapipe.tasks.vision.imagesegmenter.protoB\x1fImageSegmenterGraphOptionsProto')
  ,
  dependencies=[mediapipe_dot_framework_dot_calculator__pb2.DESCRIPTOR,mediapipe_dot_tasks_dot_cc_dot_components_dot_proto_dot_segmenter__options__pb2.DESCRIPTOR,mediapipe_dot_tasks_dot_cc_dot_core_dot_proto_dot_base__options__pb2.DESCRIPTOR,])
...
_IMAGESEGMENTERGRAPHOPTIONS.fields_by_name['segmenter_options'].message_type = mediapipe_dot_tasks_dot_cc_dot_components_dot_proto_dot_segmenter__options__pb2._SEGMENTEROPTIONS
